            ...
            if (whitemarkings_average/road1_average > brightness_ratio_threshold)
            {
                if (delta_whitemarkings_average<50)
                {
                    ...
                    if ((rx1[top_left]>Left_marging_detection) && (rx1[top_right]<Right_margin_detection))
                    {
                        ...
                        line(img6, Point(int(rx1[top_left]), int(ry1[top_left])), Point(int(rx2[top_left]),int(ry2[top_left])), Scalar(0,0,255), 6, 1);
                        line(img6, Point(int(rx1[top_right]), int(ry1[top_right])), Point(int(rx2[top_right]),int(ry2[top_right])), Scalar(0,255,0), 6, 1);
