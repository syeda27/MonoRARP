...

{
    ...
    if ((count_lane_group1 >= 1) && (count_marks_filtered_grp1 >= 1))
    {
        
        if ((initial_frame == 1) && (muy_lane_vec_final1_previous !=0 ) && (mux_lane_vec_final1_previous != 0) && (override_lane_group1==0))
        {
    ...
    if ((count_lane_group2 >= 1) && (count_marks_filtered_grp2 >= 1))
    {

        if ((initial_frame == 1) && (muy_lane_vec_final2_previous !=0 ) && (mux_lane_vec_final2_previous != 0)  && (override_lane_group2==0))
        {
