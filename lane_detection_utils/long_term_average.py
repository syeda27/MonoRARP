...
#long term average
    ...
    if count_lanes_average_vec>=6:
        ...
        cv2.line(img6, (int(base_ptx_ave), int(base_pty_ave)), (int(x1_lane),int(0)), (255,255,255), 1, cv2.LINE_AA)
        cv2.line(img6, (int(base_ptx_ave), int(base_pty_ave)), (int(x2_lane),int(H)), (255,255,255), 1, cv2.LINE_AA)   
    ...
    if count_lanes_average_vec2>=6:
        ...
        cv2.line(img6, (int(base_ptx_ave2), int(base_pty_ave2)), (int(x1_lane),int(0)), (255,255,255), 1, cv2.LINE_AA)
        cv2.line(img6, (int(base_ptx_ave2), int(base_pty_ave2)), (int(x2_lane),int(H)), (255,255,255), 1, cv2.LINE_AA)  

    return count_lanes_average_vec,count_lanes_average_vec2,mux_lane_vec_average,muy_lane_vec_average,base_ptx_lane_vec_average,base_pty_lane_vec_average,mux_lane_vec_average2,muy_lane_vec_average2,base_ptx_lane_vec_average2,base_pty_lane_vec_average2
