...
def brightness_sampling(rx1,rx2,ry1,ry2,top_left,top_right,img2):
    ...
    veclenght_top_left=((ry2[top_left]-ry1[top_left])**2+(rx2[top_left]-rx1[top_left])**2)**0.5
    veclenght_top_right=((ry2[top_right]-ry1[top_right])**2+(rx2[top_right]-rx1[top_right])**2)**0.5
    ...
    while (starting_y+counter_scanning<ry2[top_right] and starting_y+counter_scanning<ry2[top_left]):
        ...
        whitemark=img2[int(y_scanning),int((x_border_left+x_border_right)/2)]
    ...
    return road1_vec,road2_vec,road3_vec,road4_vec,whitemarkings_vec,counter_scanning
