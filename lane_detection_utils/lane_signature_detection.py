...
def lane_signature_detection(road1_average,road2_average,road3_average,road4_average,delta_road1_average,delta_road2_average,delta_road3_average,delta_road4_average,whitemarkings_average,delta_whitemarkings_average,rx1,rx2,ry1,ry2,top_left,top_right,mux_lane_vec,muy_lane_vec,base_ptx_lane_vec,base_pty_lane_vec,count_lanes_previous,count_lanes,H,img6):

    signature_detected=0

    if abs(road1_average-road2_average)/road2_average<0.15 and delta_road1_average<10 and delta_road2_average<10:
    ...
    return signature_detected,mux_lane_vec,muy_lane_vec,base_ptx_lane_vec,base_pty_lane_vec,count_lanes
