...
def scan_region(dlines,xregion,yregion,region_lenght,region_width):
    ...
    for dline in dlines[0]:
        ...
        #if x0>xregion-60 and x0<xregion+60 and y0>yregion-80 and y0<yregion+80 and x1>xregion-60 and x1<xregion+60 and y1>yregion-80 and y1<yregion+80:
        if x0>xregion-int(region_width/2) and x0<xregion+int(region_width/2) and y0>yregion-int(region_lenght/2) and y0<yregion+int(region_lenght/2) and x1>xregion-int(region_width/2) and x1<xregion+int(region_width/2) and y1>yregion-int(region_lenght/2) and y1<yregion+int(region_lenght/2):
