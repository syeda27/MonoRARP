...
class ParticleTrackerWrapper(MultiTrackerWrapper):
    def __init__(self):
        num_particles, num_trackers = 5, 10
        #self.multi_tracker = particle_tracker.ParticleTracker(num_particles, num_trackers)
        self.multi_tracker = particle_tracker_dp.ParticleTrackerDP(num_particles, num_trackers)
